...
<footer>
					...
					<div class="col-lg-3 col-sm-6">
						...
						<ul class="footer-address-list">
							<li>
								...
								<p>Email <span> <a href="mailto:info@businessname.com">info@techgater.com</a></span></p>
							</li>
							<li>
								<span><i class="fas fa-phone-alt"></i></span>
								<p>Phone <span> <a href="tel:+923035501602">+92 303 5501602</a></span></p>
							</li>
							<li>
								<span><i class="fas fa-map-marker-alt"></i></span>
								<p>Address <span> Defence Chowk Walton Raod Lahore Cant, Pakistan</span></p>
							</li>
						</ul>
					</div>
					<div class="col-lg-3 col-sm-6">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content full">
        <div class="modal-header" data-dismiss="modal">
          <img src="images/logo.png" alt="Logo" width="200px"/> <i class="far fa-times-circle"></i>
        </div>
 ...
 <div id="snackbar">Submited Successfully</div>
	<!--scroll to top-->
	...
	<script>
            ...
            $(function(){
             $("#saveusers").on('click', function(){
                 ...
                 var customCheck = $('#customCheck').val();
                 if(phone.length > 9 && email.includes("@") && email.includes(".") && name.length > 0 && subject.length > 0 && message.length > 39 )
                 {
                 $.ajax({
                   method: "POST",
