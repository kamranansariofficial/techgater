...
<!-- Mirrored from www.rajeshdoot.com/demo/niwax/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jun 2020 08:15:24 GMT -->
<head>
  <!--website title-->
  <title>Service - Web Design & Digital Marketing Agency HTML Template</title>
  <!--seo-meta-tag-->
  <meta charset="UTF-8">
...
<body>
  ...
  <header class="top-header">
      <nav class="navbar navbar-expand-lg navbar-light justify-content-right navbar-mobile fixed-top">
        <div class="container">
          <a class="navbar-brand" href="index.html"> <img src="images/logo.png" alt="Logo" width="100" /></a>
          ...
          <ul class="navbar-nav d-menu">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="homepage1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
              <div class="dropdown-menu animate slideIn" aria-labelledby="homepage1">
                <a class="dropdown-item" href="index.html">Web Development</a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="Services" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu animate slideIn" aria-labelledby="Portfolio">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu animate slideIn" aria-labelledby="Pages">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="Blog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog</a>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="common-heading text-l ">
            ...
            <h2>About Service</h2>
            <p>Techgater is an established firm for providing web applications and software as a service (SaaS). Our front-end designers and programmers have the skills and expertise to provide you a product build with latest technology. We are experienced in handling complex business logic, your unique business needs and develops solutions effectively. Our designers and developers collaborate to make the website that has flow design that looks pleasant on the user end and deliver functionality.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row upset link-hover">
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>Want to build your product with a team that establishes a clear design process, meets deadlines, and delivers a spot-on end result? Turn to Intellectsoft’s UI and UX services.</p>
        ...
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>We specialize in quality web design services to suit all businesses, Tastes, and Budgets. Whether it is a simple, Elegant web design or a custom built web design and enhancements,</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <p>We are team of experienced designers who know how to design for various screen sizes. Our designs are not just minimal desktop version designs but we know how to be beef up the efficiency.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
      </div>
  ...
  <!--        <div class="common-heading">-->
  <!--          <span>Service</span>-->
  <!--          <h2 class="mb30">Digital Marketing Service</h2>-->
  <!--        </div>-->
  <!--      </div>-->
  <!--    </div>-->
  <!--    <div class="row upset link-hover">-->
  <!--      <div class="col-lg-4 col-sm-6 mt30">-->
  <!--        <div class="s-block">-->
  <!--          <div class="s-card-icon"><img src="images/icons/seo.svg" alt="service" class="img-fluid"/></div>-->
  ...
  <!--      <div class="col-lg-4 col-sm-6 mt30">-->
  <!--        <div class="s-block">-->
  <!--          <div class="s-card-icon"><img src="images/icons/smo.svg" alt="service" class="img-fluid"/></div>-->
  ...
  <!--      </div>-->
  <!--      <div class="col-lg-4 col-sm-6 mt30">-->
  <!--        <div class="s-block js-tilt">-->
  <!--          <div class="s-card-icon"><img src="images/icons/money.svg" alt="service" class="img-fluid"/></div>-->
  <!--          <h4>Pay-per click</h4>-->
  <!--          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>-->
  <!--          <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>-->
  <!--        </div>-->
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="common-heading">
            ...
            <p class="cta-call">Or call us now <a href="tel:+823035501602"><i class="fas fa-phone-alt"></i> (+92) 303 5501602</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="email-subs">
              <h3>Get The Latest News Daily!</h3>
...
<!-- Mirrored from www.rajeshdoot.com/demo/niwax/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jun 2020 08:15:38 GMT -->
</html>
